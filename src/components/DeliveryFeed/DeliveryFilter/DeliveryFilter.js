            ...
            <div className={`flex flex-col relative `}>
              ...
              {showRating && (
                ...
                >
                  <span key={r.id}
                    className={
                      selectedFilters.includes(r.rating1) ? "active" : ""
                    }
                    onClick={() => handleFilterButtonClick(r.rating1)}
                  >
                    {r.rating1}<Star style={{fontSize:"14px"}}/> +
                  </span>
                  <span key={r.id}
                    className={
                      selectedFilters.includes(r.rating2) ? "active" : ""
                    }
                    onClick={() => handleFilterButtonClick(r.rating2)}
                  >
                    {r.rating2}<Star style={{fontSize:"14px"}}/>+
                  </span>
                  <span key={r.id}
                    className={
                      selectedFilters.includes(r.rating3) ? "active" : ""
                    }
                    onClick={() => handleFilterButtonClick(r.rating3)}
                  >
                    {r.rating3}<Star style={{fontSize:"14px"}}/>+
                  </span>
                  <span key={r.id}
                    className={
                      selectedFilters.includes(r.rating4) ? "active" : ""
                    }
                    onClick={() => handleFilterButtonClick(r.rating4)}
                  >
                    {r.rating4}<Star style={{fontSize:"14px"}}/>+
                  </span>
                </div>
              )}
            </div>
            ...
            <div className={`flex flex-col relative `}>
              ...
              {showCost && (
                ...
                >
                  <span
                    className={
                      selectedFilters.includes(c.cost1) ? "active" : ""
                    }
                  ...
                  <span
                    className={
                      selectedFilters.includes(c.cost2) ? "active" : ""
                    }
                  ...
                  <span
                    className={
                      selectedFilters.includes(c.cost3) ? "active" : ""
                    }
                  ...
                  <span
                    className={
                      selectedFilters.includes(c.cost4) ? "active" : ""
                    }
